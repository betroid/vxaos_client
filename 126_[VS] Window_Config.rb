...
class Window_Config < Window_Base
  ...
  def initialize
    ...
    Button.new(self, 78, 198, Vocab.save) { save }
    ...
    @vsync_button = Radio_Button.new(self, [[19, 124, Vocab::Vsync], [106, 124, Vocab::NoLimit]], $settings_file.vsync) { $settings_file.vsync = @vsync_button.index }
    @resolution_box = Combo_Box.new(self, 16, 170, 183, resolutions) { change_resolution }
  ...
  def refresh
    ...
    draw_text(0, 85, contents_width, line_height, Vocab::FPS, 1)
    draw_text(0, 132, contents_width, line_height, Vocab::Resolution, 1)
  end
